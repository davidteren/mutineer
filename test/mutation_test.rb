...
class MutationTest < Minitest::Test
  def test_apply_substitutes_byte_range
    source = "a + b"
    m = Mutineer::Mutation.new(start_offset: 2, end_offset: 3, replacement: "-", operator: :arithmetic)
  ...
  def test_apply_is_byte_correct_with_multibyte_prefix
    ...
    m = Mutineer::Mutation.new(start_offset: off, end_offset: off + 1,
  ...
  def test_fields_are_immutable
    m = Mutineer::Mutation.new(start_offset: 0, end_offset: 1, replacement: "-", operator: :arithmetic)
